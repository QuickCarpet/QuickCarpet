...
import quickcarpet.utils.IWorldChunk;
...
@Mixin(World.class)
public abstract class MixinWorld implements IWorld, SpawnEntityCache {
    ...
    @Shadow
    public abstract void scheduleBlockRender(BlockPos blockPos_1);
    @Shadow
