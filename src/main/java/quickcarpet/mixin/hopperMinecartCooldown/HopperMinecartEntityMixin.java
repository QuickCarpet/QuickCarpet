...
public abstract class HopperMinecartEntityMixin extends StorageMinecartEntity implements Hopper {
    ...
    private void quickcarpet$hopperMinecartCooldown$rememberBlockPos(CallbackInfo ci) {
    ...
    private void quickcarpet$hopperMinecartCooldown$extractAndReturnSuccess(CallbackInfoReturnable<Boolean> cir, List<?> list_1) {
        if (Settings.hopperMinecartCooldown != 0) {
    ...
    private int quickcarpet$hopperMinecartCooldown$cooldownAmount(int original) {
