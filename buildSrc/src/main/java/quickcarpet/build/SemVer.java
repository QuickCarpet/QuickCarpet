...
class SemVer {
    ...
    public SemVer(String version) {
        ...
        this.pre = minus >= 0 ? new ArrayList<>(Arrays.asList(version.substring(minus + 1, endMinus).split("\\."))) : new ArrayList<>();
        this.build = plus >= 0 ? new ArrayList<>(Arrays.asList(version.substring(plus + 1).split("\\."))) : new ArrayList<>();
    }
